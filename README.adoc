...
:description: wrapper to invoke https://github.com/json-path/JsonPath methods via an API.
:author: Sumiya
:nofooter:
:sectlinks:
...
With the above setup, the end to end flow for an API request from the linked html page is:
